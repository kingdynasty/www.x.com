...
<div class="pad_10">
<form name="myform" action="?m=Admin&c=Linkage&a=publicListorder" method="post">
...
function add(id, name,linkageid) {
	...
	window.top.art.dialog({title:name,id:'add',iframe:'?m=Admin&c=Linkage&a=publicSubAdd&keyid='+id+'&linkageid='+linkageid,width:'500',height:'320'}, function(){var d = window.top.art.dialog({id:'add'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'add'}).close()});
}
