...
<!--
	...
	function load_file_list(id) {
		if(id=='') return false;
		$.getJSON('?m=Admin&c=Category&a=publicTplFileList&style='+id+'&catid=<?php echo $catid?>&type=1', function(data){$('#page_template').html(data.page_template);});
	}
