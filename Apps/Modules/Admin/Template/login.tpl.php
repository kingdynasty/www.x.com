...
<div id="login_bg" class="login_box">
    ...
    <div id="yzm" class="yzm"><?php echo Form::checkcode('code_img')?><br /><a href="javascript:document.getElementById('code_img').src='<?php echo SITE_PROTOCOL.SITE_URL.SITE_PATH;?>api.php?op=checkcode&m=Admin&c=Index&a=checkcode&time='+Math.random();void(0);"><?php echo L('click_change_validate')?></a></div>
     </form>
    </div>
